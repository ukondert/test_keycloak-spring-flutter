...
- **Tech Stack:**
  ...
  - Keycloak 23.0.3 for authentication & authorization
  - Lombok 1.18.30, MapStruct 1.5.5
...
**Security & Keycloak:**
- Configure Spring Security with JWT/Keycloak in `SecurityConfig.java`
- Implement Anti-Corruption Layer for external authentication/authorization systems in dedicated module, use online-docs https://www.keycloak.org/documentation for reference
- Use `@PreAuthorize` for method-level security
- Configure Keycloak realm, client, roles in `application.yml`
