...
## Overview
This chatmode simulates an interview with a master stakeholder to determine requirements for the BMAD method. The AI acts as the master stakeholder while the user conducts the interview.
